/* key.c -- Generated array containing function names.
   ...
   command "/usr/src/minix_trabalho_SO/gnu/usr.bin/texinfo/makedoc/makedoc".  DO NOT EDIT THIS FILE, only "/usr/src/minix_trabalho_SO/gnu/usr.bin/texinfo/makedoc/makedoc.c".

   Source files groveled to make this file include:

	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/session.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/echo-area.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/infodoc.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/m-x.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/indices.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/nodemenu.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/footnotes.c
	/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/variables.c
...
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/session.c". */
...
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/echo-area.c". */
...
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/infodoc.c". */
...
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/m-x.c". */
   { "describe-command", A_describe_command },
   { "execute-command", A_info_execute_command },
   { "set-screen-height", A_set_screen_height },
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/indices.c". */
   { "index-search", A_info_index_search },
   { "next-index-match", A_info_next_index_match },
   { "index-apropos", A_info_index_apropos },
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/nodemenu.c". */
   { "list-visited-nodes", A_list_visited_nodes },
   { "select-visited-node", A_select_visited_node },
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/footnotes.c". */
   { "show-footnotes", A_info_show_footnotes },
/* Commands found in "/usr/src/minix_trabalho_SO/gnu/dist/texinfo/info/variables.c". */
